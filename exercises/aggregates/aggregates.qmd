...
Data frame gives a summary of advanced statistics for NBA players. Repeat names of a player means that they played for multiple teams. 
...
**Answer** DESCRIBE THE RESULTS HERE
The positions of NBA players are distributed relatively evenly, with some more weight toward SG and C, with a very small number of "hybrid" players w/ diff. positions. 
...
The hyphenated 'hybrid' positions mess up some of the data, some are not properly categorized. 
...
**ANSWER**
SG-PG seem to have significant amounts of minutes played - even the minimum amount played quite a bit of time. Although PF seems to be a 'dying' position, they still play an average amount. Are PF's really PF's though?
