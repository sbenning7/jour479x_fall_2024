...
```
There are a few things that we can be pretty certain about with their relationship to how many years a player will last in the league. Age is a pretty key factor, 
